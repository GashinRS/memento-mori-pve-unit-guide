...
Fia is without a doubt one of the most important limited units you can pull for PVE. Technically she is usable
        ...
        4 LR instead of 4 UR gear for even more HP.

**Main Quest —** Fia's support role is most prevalent in main quest where you will often
    use her to buff up level 1 Nina (and sometimes Winter Tropon's) HP. If you want to use her as a DPS, Yildiz is a
    must-have for the additional bulk, and LR5 also improves her performance by a big amount.

**Tower —**In tower Fia will mostly be used as a DPS. Because of lower enemy attack stats compared to
