...
teams:
  ...
  - label: 
    slots: [Cordie, Xamour, SmoddeyUR, Artie, LunaLR]
---

As mentioned in Moineau's section, Summer Moddey is the main catalyst that allows for the highest damage dealing
        team in the entire game, under the right circumstances. For details on how that works, please refer to Moineau's
        section.

What is not covered in that section however is the fact that Summer Moddey herself can also be a great DPS due to
