...
teams:
  ...
  - label: 
    slots: [Cordie, Meria, Moineau, Samleth, Eirene]
  - label: Main quest only
    slots: [Cordie, Merlyn, Moineau, SmoddeySR, Eirene]
---

Moineau has a ton of effects, which combined, make her into one of the best support units in the game that can even
        ...
        action phase. Due to the vast nature of her effects, her usage in tower and main quest differs a lot.

**Main Quest — ** Moineau's primary role in main quest is as a DPS. This is made possible by
        ...
        RNG required to clear stages.

**Tower — ** In tower, she is only used as a debuffer, where her 50% P.DEF debuff can pair with another unit's 50% P.DEF debuff
