...
teams:
  ...
  - label: 
    slots: [Belle, FiaLR5, Merlyn, Yildiz, Milla]
---

Belle is a very unique unit; she has a passive that can grant her shields based on the amount of damage she
        ...
        beyond LR for this purpose.

In the first example team, Dian is the main DPS. Since Dian can get the Invisibility buff when at least
         one ally is alive, Belle can act as the immortal partner which allows Dian to continuously chip away at the enemies
         which her direct damage from her S2.
